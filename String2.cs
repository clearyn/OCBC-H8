...
class String2
{
    public static void Main()
    {
        ...
        Console.WriteLine("Panjang str1: "+ str1);
        ...
        // Showing each character in array str1
        ...
        //Compare string equal == and not equal !=, ordinal comparation
        if (str1 == str2){
        ...
        Console.WriteLine("Indeks kemuncul terakhir dari Satu: " + idx);
    }
}